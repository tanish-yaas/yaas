...
export default async function OnboardingPage({
  ...
  const defaultTz = timezones.includes("Asia/Kolkata")
    ? "Asia/Kolkata"
    : timezones[0];
    ...
    <main className="aurora flex min-h-screen items-center justify-center px-6 py-16">
      <div className="glass w-full max-w-lg rounded-2xl px-8 py-10">
        ...
        <form action={completeOnboarding} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="jobTitle" className="text-xs font-medium text-muted-foreground">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="workingHoursStart" className="text-xs font-medium text-muted-foreground">
                Day starts
              </label>
              <select
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="workingHoursEnd" className="text-xs font-medium text-muted-foreground">
                Day ends
              </label>
              <select
                id="workingHoursEnd"

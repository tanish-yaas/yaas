      ...
      {dayKey && (
        <>
          ...
          <motion.aside
            ...
            className="fixed inset-x-0 bottom-0 z-[91] flex max-h-[85vh] flex-col rounded-t-2xl border border-border bg-card md:inset-y-0 md:left-auto md:right-0 md:max-h-none md:w-[26rem] md:rounded-none md:rounded-l-2xl md:border-y-0 md:border-r-0"
          >
            ...
            <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4">
                ...
                <div className="mb-4">
                  {creating ? (
                    ...
                    <button
                      ...
                      className="inline-flex h-9 w-full items-center justify-center gap-2 rounded-lg border border-dashed border-border text-xs text-muted-foreground transition-colors hover:border-brand-violet hover:text-foreground"
                    >
              ...
              {dayEvents.length > 0 && (
                <section className="mb-5">
                  <h3 className="mb-2 px-1 text-[10px] uppercase tracking-[0.2em] text-muted-foreground">
                    Events
                  </h3>
                  <div className="flex flex-col gap-1.5">
                    {dayEvents.map((event) =>
                      editingId === event.id ? (
                        ...
                        <div
                          key={event.id}
                          className="group flex items-start gap-2.5 rounded-lg px-2 py-2 transition-colors hover:bg-secondary/40"
                        >
                          <span
                          ...
                          >
                            ...
                            {event.taskTitle && (
                              <p className="mt-0.5 truncate text-[11px] text-brand-violet">
                                ↳ {event.taskTitle}
                              </p>
                            )}
                          </button>
              ...
              {dayTasks.length > 0 && (
                <section>
                  ...
                  <div className="rounded-lg border border-border/50 px-1 py-1">
                    {dayTasks.map((task) => (
